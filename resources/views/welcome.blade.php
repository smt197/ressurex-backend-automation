        ...
        <header class="relative z-10">
            <nav class="container mx-auto px-6 py-8">
                <div class="flex justify-between items-center">
                    ...
                    @auth
                    <a href="{{ url('/dashboard') }}" class="glass-effect text-white px-6 py-2.5 rounded-lg font-medium hover:bg-white hover:bg-opacity-20 transition duration-300">
                        Dashboard
                    </a>
                    @else
                ...
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-white space-y-8 animate-fade-in">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            @guest
                            <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                            ...
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-4 glass-effect text-white rounded-lg font-semibold hover:bg-white hover:bg-opacity-20 transition duration-300">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @endif
                            @else
                            <a href="{{ url('/dashboard') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="glass-effect rounded-2xl p-8 shadow-2xl animate-fade-in" style="animation-delay: 0.2s;">
                        <div class="bg-white rounded-xl p-8">
                            ...
                            <div class="text-center space-y-4">
                                ...
                                <a href="{{ url('/dashboard') }}" class="block w-full text-center px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition duration-300 shadow-lg hover:shadow-xl">
                                    Go to Dashboard
                                </a>
                            </div>
                            @endguest
