                ...
                <tr>
                    <td style="width: 552px; max-width: 100%">
                        <div class="sm-my-8" style="margin-top: 3rem; margin-bottom: 3rem; text-align: center">
                            <a href="{{ config('app.url_frontend') }}">
                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                            <tr>
                                <td class="sm-px-6 text-slate-950 bg-white" style="background-color: rgb(255 255 255 / 1); padding: 3rem; font-size: 1rem; line-height: 1.5rem; color: rgb(2 6 23 / 1)">
                                    ...
                                    <div class="bg-zinc-100 border-zinc-300" style="border-radius: 1rem; border: 1px solid rgb(212 212 216 / 1); background-color: rgb(244 244 245 / 1); padding: 2rem; text-align: center">
                                        <div style="font-size: 2.5rem; font-weight: bold; color: #1F2937; letter-spacing: 0.25rem; margin-bottom: 1rem; font-family: 'Courier New', monospace;">
                                            {{ str_replace('-', '', $code) }}
                                        </div>
                                    </div>
                                    @else
                                    ...
                                    <div class="bg-zinc-100 border-zinc-300" style="border-radius: 1rem; border: 1px solid rgb(212 212 216 / 1); background-color: rgb(244 244 245 / 1); padding: 1rem; text-align: center">
                                        <a href="{{ $url }}" class="btn"
                                            style="display: inline-block; background-color: #6B7280; color: white; font-size: 16px; font-weight: bold; 
                                               text-decoration: none; padding: 12px 24px; border-radius: 8px; text-align: center; 
